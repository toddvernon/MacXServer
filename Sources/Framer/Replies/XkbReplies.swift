...
// MARK: - XkbGetIndicatorMap reply (header + raw trailer)
...
public struct XkbGetIndicatorMapReply: Equatable, Sendable {
    ...
    /// 12-byte-per-indicator IndicatorMapWireDesc array; trivial to
    /// decode in Session 3 once we want the per-indicator details.
    public var trailer: [UInt8]
