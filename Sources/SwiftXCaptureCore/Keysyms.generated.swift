// Generated from reference/X11R6/xc/include/keysymdef.h on 2026-05-31.
// Do not edit by hand; regenerate with:
//   Tools/regen_keysyms.sh
//
// 1224 unique keysym values, first-name-wins on aliases.

/// Canonical X11 keysym names, indexed by keysym value (CARD32).
/// Decode-side only; the protocol carries the integer, this table
/// lifts it to a readable name for dumper output.
public let xKeysymNames: [UInt32: String] = [
    0xFFFFFF: "VoidSymbol",
    0xFF08: "BackSpace",
    0xFF09: "Tab",
    0xFF0A: "Linefeed",
